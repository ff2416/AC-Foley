...
from ac_foley.utils.av_utils import ImageInfo, VideoInfo, read_frames, reencode_with_audio
from ac_foley.model.flow_matching import FlowMatching
from ac_foley.model.networks import AC_Foley
from ac_foley.model.sequence_config import CONFIG_AC, SequenceConfig
...
class ModelConfig:
    model_path: Path
    vae_path: Path = Path('./weights/v1-44.pth')
    synchformer_ckpt: Path = Path('./weights/synchformer_state_dict.pth')
