...
from ac_foley.ext.synchformer.motionformer import MotionFormer
...
if __name__ == "__main__":
    ...
    # sd = torch.load('./weights/sync_model_audioset.pt')['model']
    # torch.save(sd, './weights/synchformer_state_dict.pth')
