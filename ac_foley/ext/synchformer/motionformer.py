...
from ac_foley.ext.synchformer.utils import check_if_file_exists_else_download
from ac_foley.ext.synchformer.video_model_builder import VisionTransformer
