...
from ac_foley.ext.rotary_embeddings import compute_rope_rotations
from ac_foley.model.embeddings import TimestepEmbedder
from ac_foley.model.low_level import MLP, ChannelLastConv1d, ConvMLP
from ac_foley.model.transformer_layers import (FinalBlock, JointBlock, MMDitSingleBlock)
...
def get_ac_foley(**kwargs) -> AC_Foley:
    return AC_Foley(
        latent_dim=40,
        clip_dim=1024,
        sync_dim=768,
