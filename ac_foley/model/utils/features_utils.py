...
from ac_foley.ext.autoencoder import AutoEncoderModule
from ac_foley.ext.mel_converter import get_mel_converter
from ac_foley.ext.synchformer import Synchformer
    ...
    def __init__(
        ...
        *,
        ...
        if tod_vae_ckpt is not None:
            self.mel_converter = get_mel_converter()
